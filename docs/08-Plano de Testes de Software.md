...
| **Passos** 	| -	Acessar a aplicação por link público; -	Na homepage clicar em “Entrar”; -	Aguardar carregamento da página; -	Selecionar “login” ou “cadastro”; -	Verificar redirecionamento correto para página login ou cadastro;|

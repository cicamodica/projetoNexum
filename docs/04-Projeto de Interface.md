...
### Tela de Pesquisa 
Apresenta capo para realizar pesquisa e sugestões. Requisitos associados: RF-05
...
Apresenta resulatados da pesquisa, mostrando varias opções dentro da palavra chave buscada. Requisitos associados:  RF-05
...
Apresenta a extensão da tela de Marketplace para realizar a doação de algo fisico. Requisitos associados: RF-05
...
Demostra possiveis oportunidades de voluntariado com um filtro para se achar algo especifico.Requisitos associados:  RF-05
